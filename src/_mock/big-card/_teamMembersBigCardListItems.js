export const listItems = {
  ...
  items: [
    ...
    "Team members can be granted either 'Write' or 'Read' access. With 'Write' access, they can upload email lists for verification, while 'Read' access allows them only to download verification reports.",
